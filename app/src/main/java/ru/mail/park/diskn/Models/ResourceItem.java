...
public class ResourceItem {
    ...
    public ResourceItem(String resourceId, String name, String created, String modified, String fileURL, BigDecimal size, String media_type, String type, String preview) {
